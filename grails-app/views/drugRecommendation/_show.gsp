...
<html>
	...
	<body>
		...
		<div id="show-drugRecommendation" class="content scaffold-show" role="main">
			...
			<ul class="property-list drugRecommendation nobullets">
				...
				<li class="fieldcontain">
					<span id="recommendation-label" class="property-label nextline"><g:message code="drugRecommendation.recommendation.label" default="Recommendation" />
					(
				...
				<li class="fieldcontain">
					<span id="implications-label" class="property-label nextline"><g:message code="drugRecommendation.implications.label" default="Implications" />:</span>
				...
				<li class="fieldcontain">
					<span id="diplotypeEgs-label" class="property-label nextline"><g:message code="drugRecommendation.diplotypeEgs.label" default="Diplotype Egs" />:</span>
