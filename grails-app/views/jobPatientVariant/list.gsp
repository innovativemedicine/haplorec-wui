	...
	<body>
		...
		<div id="list-jobPatientVariant" class="content scaffold-list" role="main">
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="patientId" title="${message(code: 'jobPatientVariant.patientId.label', default: 'Patient Id')}" />
					
						<g:sortableColumn property="physicalChromosome" title="${message(code: 'jobPatientVariant.physicalChromosome.label', default: 'Physical Chromosome')}" />
					
						<g:sortableColumn property="snpId" title="${message(code: 'jobPatientVariant.snpId.label', default: 'Snp Id')}" />
					
						<g:sortableColumn property="allele" title="${message(code: 'jobPatientVariant.allele.label', default: 'Allele')}" />
					
						<g:sortableColumn property="zygosity" title="${message(code: 'jobPatientVariant.zygosity.label', default: 'Zygosity')}" />
			...
			<div class="pagination">
				<g:paginate total="${jobPatientVariantInstanceTotal}" />
			</div>
		</div>
	</body>
</html>
